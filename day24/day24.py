...
# posted about my solution on r/adventofcode:
# https://old.reddit.com/r/adventofcode/comments/18pnycy/comment/keq1ypd/
...
def main():
	hailstones = []
	for line in open("day24/day24-input.txt").readlines():
